...
CREATE TABLE Parts(
 ...
 CONSTRAINT FK_Parts_Vendors FOREIGN KEY(VendorId) REFERENCES
 Vendors(VendorId),
)
...
CREATE TABLE OrderParts(
 ...
 CONSTRAINT FK_OrderParts_Parts FOREIGN KEY(PartId) REFERENCES
 Parts(PartId),
 CONSTRAINT FK_OrderParts_Orders FOREIGN KEY(OrderId) REFERENCES
 Orders(OrderId)
)
...
CREATE TABLE PartsNeeded(
 ...
 CONSTRAINT FK_PartsNeeded_Parts FOREIGN KEY(PartId) REFERENCES
 Parts(PartId),
 CONSTRAINT FK_PartsNeeded_Orders FOREIGN KEY(JobId) REFERENCES
 Jobs(JobId)
)
