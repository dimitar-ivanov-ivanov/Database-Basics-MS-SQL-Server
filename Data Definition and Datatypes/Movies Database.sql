...
CREATE TABLE Movies(
 ...
 CONSTRAINT CK_Movies_CopyrightYear CHECK (CopyrightYear >=1930),
 CONSTRAINT CK_Movies_Rating CHECK (Rating >=1 AND Rating <=10),
...
VALUES
	...
	('Quentin Tarantino','Film-making master')
